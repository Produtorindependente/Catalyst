        ...
        if (ehGranel) {
            ...
            quantidadeHTML = `
                <div class="quantidade-granel">
                    ...
                    <label for="peso-${produto.id ?? produto.nome}">
                        Quantidade
                    </label>
                    ...
                    <div class="campo-peso">
                        ...
                        <input
                            type="number"
                            id="peso-${produto.id ?? produto.nome}"
                            min="1"
                            step="1"
                            value="100"
                            inputmode="numeric"
                    ...
                    <button
                        class="botao"
                        onclick="adicionarAoCarrinho(${produto.id}, Number(document.getElementById('peso-${produto.id ?? produto.nome}').value))"
                    >
...
function atualizarCarrinho() {
    ...
    carrinho.forEach(item => {
        ...
        const detalheCarrinho =
            item.tipoVenda === "peso"
                ? `${item.peso}g — R$ ${item.preco
                    .toFixed(2)
                    .replace(".", ",")}`
